...
def HomeView(page: ft.Page):
    # Контейнер для списка (чтобы можно было его очищать и обновлять)
    ...
    def confirm_delete_click(e):
        if delete_target_id:
            ...
            page.show_dialog(
                ft.SnackBar(ft.Text("Инструкция удалена"), bgcolor=ft.Colors.RED_700)
            )
    ...
    confirm_dialog = ft.AlertDialog(
        ...
        actions=[
            ...
            ft.ElevatedButton(
                "Удалить", on_click=confirm_delete_click, color="white", bgcolor="red"
            ),
        ],
    ...
    def load_items():
        ...
        if not items:
            list_items.controls.append(
                ft.Text("Нет инструкций. Создайте первую!", italic=True)
            )
                    ...
                    trailing=ft.Row(
                        controls=[
                            ...
                            ft.IconButton(
                                ...
                                tooltip="Запустить",
                                icon_color="green",
                                on_click=lambda _, id=item["id"]: open_execution_logs(
                                    page, id
                                ),
                            ),
                            ...
                            ft.IconButton(
                                ...
                                icon_color="orange",
                                on_click=lambda _, id=item["id"]: page.go(
                                    f"/edit/{id}"
                                ),
                            ),
                            # Кнопка Удаления
                            ft.IconButton(
                                ...
                                tooltip="Удалить",
                                icon_color="red",
                                on_click=lambda _, id=item["id"]: open_delete_dialog(
                                    id
                                ),
                            ),
                        ],
    ...
    return ft.View(
        ...
        controls=[
            ft.AppBar(
                title=ft.Text("Мои инструкции", color=ft.Colors.BLACK),
                bgcolor=ft.Colors.ON_SURFACE_VARIANT,
            ),
            list_items,
            ft.FloatingActionButton(
                icon=ft.Icons.ADD, on_click=lambda _: page.go("/create")
            ),
        ],
    )
            ...
            ft.Column(
                controls=[
                    ...
                    ft.IconButton(
                        icon=ft.Icons.EDIT,
                        icon_color="orange",
                        on_click=lambda _: page.go(f"/edit/{inst_id}"),
                    ),
                    ft.Divider(),
